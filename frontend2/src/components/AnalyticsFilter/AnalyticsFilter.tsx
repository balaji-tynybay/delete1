        ...
        <TabPanel value={value} index={0}>
          <div>
              ...
              <AccordionDetails>
                ...
                <ul className="time-frame-filter-box">
                  {timeFrameData.map((each => (
                    // <li
                    //   onClick={() => {
                    //     handleFrameClick(eachItem.display);
                        
                    //     setShowMore(true);
                    //     setShowMore(!showMore);
                    //   }}
                    //   className={
                    //     activeTimeFrame === eachItem.display
            ...
            <MuiAccordion>
              ...
              <AccordionDetails>
                <ul className="time-frame-filter-box">
                  {predictionData1.map((eachItem) => (
                    <li
                    key={eachItem.value}
                      onClick={() => {
                        handleFrameClick(eachItem.display);
                        handleGroupByChange(eachItem.value);
